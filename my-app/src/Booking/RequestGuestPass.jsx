...
import { HiOutlineArrowLeft, HiClock } from "react-icons/hi";
      ...
      >
        ...
        <div className="bg-blue-50 dark:bg-blue-900/20 border border-blue-200 dark:border-blue-800 rounded-md p-4">
          <div className="flex items-center gap-2 mb-4">
            <HiClock className="text-blue-600 dark:text-blue-400" size={18} />
          ...
          <div className="grid grid-cols-2 gap-4">
            ...
            <div>
              <label
                htmlFor="arrivalTime"
                className="block text-xs font-medium text-gray-600 dark:text-gray-400 mb-1 uppercase tracking-wide"
              >
                Arrival Time *
              </label>
              <input
                ...
                required
                className="w-full p-2.5 bg-gray-100 dark:bg-gray-700 text-gray-900 dark:text-white border border-gray-300 dark:border-gray-600 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500 text-sm"
              />
            </div>
          ...
          <p className="text-xs text-gray-500 dark:text-gray-400 mt-2">
            Guest can enter from arrival time and must leave by departure time.
          </p>
        </div>
